...
from litex.soc.cores.somador_andre import Somador
from litex.soc.cores.ising_model import Ising_model
...
class SimSoC(SoCCore):
    def __init__(self,
        ...
        **kwargs):
        ...
        #ANDRE_SOMA---------------------------------------------------------------------------------
        self.somador = Somador(5,5,10)
        
        platform.add_sources("complete_peripheral.v")
